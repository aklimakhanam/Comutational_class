...
x_r, integral_r, a_r = Integral.riemann_sum(Integral.force, -10, 10, 100)
x_t, integral_t, a_t = Integral.trapezoidal(Integral.force, -10, 10, 100)
x_s, integral_s, a_s = Integral.simpsons_rule(Integral.force, -10, 10, 100)
x_sc, integral_sc = Integral.Scipy_integral(Integral.force, -10, 10, k, 100)
x_an, integral_an = Integral.analytical(Integral.force, -10, 10, k, 100)
...
plt.figure(figsize=(12, 6))
plt.plot(x_r, PE_r, label='PE', linestyle='-')
plt.plot(x_r, KE_r, label='KE', linestyle='-')
plt.plot(x_r, E_r, label='Total energy E', linestyle='-')
plt.xlabel('Displacement (x)')
plt.ylabel('Energy')
